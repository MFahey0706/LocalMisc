...
for i in range(N):
    ...
    Full_order_list.sort() #defaultsort for list of lists is to sort on first elem of each list
...
while Orders_done < N:
    ...
    while Start <= Kitchen_time and Orders_taken < N:
        Start = Full_order_list[Orders_taken][0]
        if Start <= Kitchen_time:
